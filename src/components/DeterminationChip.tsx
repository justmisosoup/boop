...
/**
 * The determination a report reached, as the businesses list shows it.
 *
 * It replaces the record's review status in the Status column. The status is
 * Middesk's word on the order; the determination is the assessment's word on
...
export const DeterminationChip = ({ band }: { band: ScoreBand | null }) => (
